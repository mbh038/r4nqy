# Mean adult height by year of birth, males vs. females - Data package

This data package contains the data that powers the chart ["Mean adult height by year of birth, males vs. females"](https://ourworldindata.org/grapher/mean-height-males-vs-females?endpointsOnly=1&time=1996&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
...
#### Full citation
NCD RisC, Human Height (2017) – processed by Our World in Data. “Mean female height (cm)” [dataset]. NCD RisC, Human Height (2017) [original data].
Source: NCD RisC, Human Height (2017) – processed by Our World In Data
