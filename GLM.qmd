...
For many common analyses of those variables, such as  at-test, regression, ANOVA, or in fact any manifestation of the linear model, the data needs to have the following attributes:
...
- nagative binoliam date - useful for clumped count data wit high dispersion
