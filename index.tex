...
\chapter{Test finder flow chart}\label{test-finder-flow-chart}
...
\chapter{Two sample t-test: the parametric
...
\section{\texorpdfstring{When to use the two-sample
...
\chapter{The non-parametric case}\label{the-non-parametric-case}
...
\chapter{Paired data}\label{paired-data}
...
\section{Which test: paired t-test or Wilcoxon signed rank
...
\subsection{Test output}\label{test-output}
...
\section{The non-parametric alternative: The Wilcoxon signed rank
...
\section{Relation to one-sample paired
