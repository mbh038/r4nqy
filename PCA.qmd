...
In studies of the natural world it is common to make observations at several sites or of individual samples,  animals or plants. At each site or for each individual sample, plant or animal it is also common to make measurements of several different variables. Where these are environmental variables that are measured using a numerical scale the principal component analysis is a useful ordination teachnique.



## Example One: Geological samples

This exercise is adapted slightly from that of Holland [-@holland2019]
