...
g2<-ggplot(penguins,aes(x=ID,y=bill_shape,colour=species))+
  ...
  theme_cowplot() +
  theme(legend.position = c(0.58,0.20))
```
...
SSF is the **species sum of squares**. This is the sum of the squares of the deviations of the species means from the grand mean. This is a measure of the variation between individuals of different species.
