...
For this chapter you will find it useful to have [this RStudio project folder](https://github.com/mbh038/ANOVA-two-way-with-model-simplification/archive/refs/heads/main.zip) if you wish to follow along and try out the exercises at the end.
...
summary.table <- broom::tidy(summary(model0)) |>
  ...
  mutate(p_value = case_when(
    p.value <= 0.001 ~ "<0.001",
    p.value > 0.001 & p.value <= 0.01 ~ "<0.01",
    p.value > 0.01 & p.value <= 0.05 ~ as.character(round(p.value,3)),
    p.value > 0.05 ~ "n.s.")) |>
