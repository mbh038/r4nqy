...
For this chapter you will find it useful to have [this RStudio project folder](https://github.com/mbh038/correlation/archive/refs/heads/main.zip)
...
1. If you haven't done so already, click on [this link](https://github.com/mbh038/correlation/archive/refs/heads/main.zip) to download the practice project for correlation. 

[this link](https://github.com/mbh038/correlation/archive/refs/heads/main.zip)

2. Open this project in RStudio by navigating to the project then clicking on the `correlation.Rproj` file
...
5. Check that you have created data frames called `penguins` and `iris`
...
8. Use the `filter()` function from the `dplyr` package in `tidyverse` to filter the penguin data dwon to Adelie females. Save the data in data frame called `adelie_f`. You can do this by including the following code chunk in your notebook:
...
12. Use the `cor.test()` function to determine if the bill length and bill depth variabls are correlated. Use either Pearson or Spearman's rank, as appropriate.
