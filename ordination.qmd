...
Ordination is the general term for a clutch of techniques that try to find order in this chaos. A main task is to reduce the dimensionality of a problem down to two or three such that the patterns that exist in the full data set are at least approximately preserved, but can now be displayed on a two-dimesional plot and made sense of.
